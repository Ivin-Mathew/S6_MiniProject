...
# Generate point cloud, then join the vertices to fill as faces.
...
def point_cloud_to_mesh(pcd, method="poisson"):
    ...
    """
    # We need to estimate normals for the point cloud first
    ...
    if method == "poisson":
        ...
        raise ValueError("Method must be either 'poisson' or 'bpa'")
